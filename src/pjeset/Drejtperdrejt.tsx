/**
 * Paneli i lidhjes së drejtpërdrejtë — ana e atij që mban pikët.
 *
 * Tregon ftesën si kod QR dhe pret përgjigjen. Shkëmbimi ka dy hapa e jo një,
 * sepse WebRTC-ja kërkon që të dy anët t'i njohin kredencialet e njëra-tjetrës
 * dhe server sinjalizimi nuk ka: kush shikon skanon ftesën, dhe pastaj tregon
 * një kod të vetin që skanohet nga kjo anë.
 *
    ...
    return (
      <div className="drejtperdrejt">
        <p className="ndihma">
          ...
          përditësohen vetë pas çdo raundi. Nuk kalojnë nëpër asnjë server.
        </p>
