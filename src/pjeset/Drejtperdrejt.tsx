 ...
 * - **Me kod** (`MeServer`): një kod i vetëm, punon edhe nëpër rrjeta të
 *   ndryshme — por i duhet internet dhe një server i huaj për t'i lidhur.
 *
 * E para rri e parazgjedhur, dhe kjo është vendim e jo rastësi: pika 1 e
 * `CLAUDE.md`-së mbetet e paprekur për kë nuk e ndërron. E dyta nuk niset vetë
 * kurrë — as pas një dështimi të së parës, sepse një kalim i heshtur te serveri
 * do të ishte pikërisht ajo që pika 1 ndalon.
 *
...
export function Drejtperdrejt({ paketa }: { paketa: string }) {
  const [menyra, caktoMenyren] = useState<Menyra>('pa');
