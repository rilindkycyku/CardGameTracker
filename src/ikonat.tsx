...
const SHTIGJET: Record<string, JSX.Element> = {
  ...
  kamera: (
    <>
      <path d="M4.4 8.6h2.4l1.5-2.2h7.4l1.5 2.2h2.4a1.6 1.6 0 0 1 1.6 1.6v7.2a1.6 1.6 0 0 1-1.6 1.6H4.4a1.6 1.6 0 0 1-1.6-1.6v-7.2a1.6 1.6 0 0 1 1.6-1.6Z" />
  ...
  reja: (
    <>
      <path d="M7.2 19.2a4.4 4.4 0 0 1-.5-8.77 5.6 5.6 0 0 1 10.83-1.2A3.9 3.9 0 0 1 17.4 19.2Z" />
    </>
  ),
  sinkronizimi: (
    <>
      <path d="M3.8 12a8.2 8.2 0 0 1 13.9-5.9l2.5 2.3" />
      <path d="M20.2 12a8.2 8.2 0 0 1-13.9 5.9l-2.5-2.3" />
      <path d="M20.6 3.7v4.9h-4.9M3.4 20.3v-4.9h4.9" />
    </>
  ),
  telefoni: (
    <>
