...
const RENDITJA = [
  ...
  "0111110001000000000000000",
  "1100001000000010010010100",
  "1100000100011110100011100",
  "0000011011010001011011110",
  "0011100110110101011010011",
  "0111111000101010000101110",
  "1011100011101101000101011",
  "0010001111010000111110110",
  "0000000010001100100010101",
  "1111111000111000101011011",
  "1000001000101001100010011",
  "1011101001111100111111000",
  "1011101010101111011110011",
  "1011101010011101011011010",
  "1000001011100001010000100",
  "1111111010001010011010111"
];
...
test('kodi i një renditjeje del bit për bit ashtu si u lexua', () => {
  assert.deepEqual(siVargje(kodiQR('alfa 594, beta 380')), RENDITJA);
});
